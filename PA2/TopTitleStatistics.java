...
// <<< Don't Change
    ...
    public static class TitleCountMap extends Mapper<Object, Text, Text, IntWritable> {
        ...
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
            ...
            StringTokenizer t = new StringTokenizer(line, this.delimiters);
            while(t.hasMoreTokens()){
                String s = t.nextToken().toLowerCase().trim();
    ...
    public static class TopTitlesStatMap extends Mapper<Text, Text, NullWritable, TextArrayWritable> {
        ...
        public void map(Text key, Text value, Context context) throws IOException, InterruptedException {
            // TODO
            l.add(new Pair<>(Integer.valueOf(value.toString()),key.toString()));
        }
        ...
        protected void cleanup(Context context) throws IOException, InterruptedException {
            ...
            int n = (N<l.size())?N:l.size();
            for(int i=0;i<n;i++){
                String[] strings = {l.get(i).second, l.get(i).first.toString()};
    ...
    public static class TopTitlesStatReduce extends Reducer<NullWritable, TextArrayWritable, Text, IntWritable> {
        ...
        public void reduce(NullWritable key, Iterable<TextArrayWritable> values, Context context) throws IOException, InterruptedException {
            Integer sum = 0, mean, max = 0, min = Integer.MAX_VALUE, var = 0, i=0;

            // TODO
            Integer[] num = new Integer[N];
            for(TextArrayWritable v:values){
                Text[] s = (Text[])v.toArray();
                num[i] = Integer.valueOf(s[1].toString());
